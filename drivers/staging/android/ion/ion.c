...
/* TSAI: needed by drivers/video/rockchip/rkfb_sysfs.c*/
...
/* needed by drivers/staging/android/ion/rockchip/rockchip_ion.c*/
...
//TSAI: this function body is missing
//#ifdef CONFIG_ROCKCHIP_IOMMU
...
struct ion_handle *ion_import_dma_buf(struct ion_client *client, int fd)
{
	...
	dma_buf_put(dmabuf);
#if TSAI_DS5
	SRUK_ANNOTATE_CHANNEL_COLOR_TS(3, ANNOTATE_PURPLE, &ts, "ion_import_dma_buf %d buf %d", fd, handle->buffer->tsai_seqno);
	ANNOTATE_CHANNEL_END(3);
#endif
	return handle;
}
