...
/* Must not be static! */
#if TSAI
/* remove the __init keyword because
WARNING: /home/SERILOCAL/cheng.tsai/Disk2TB/dtv/km220171113/gator/gator-driver/gator.o(.data+0x108): Section mismatch in reference from the variable gator_events_list to the function .init.text:gator_events_mmapped_init()
The variable gator_events_list references
the function __init gator_events_mmapped_init()
 * */
